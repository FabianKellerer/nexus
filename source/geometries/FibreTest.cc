...
void FibreTest::Construct(){
    ...
    GenericWLSFiber* fiber_ = new GenericWLSFiber("Y11", true, radius_, length_, 0.02, true, true, tpb, ps, true);
    fiber_->SetCoreOpticalProperties(opticalprops::Y11(syst_WLSY11, syst_Y11, 1, 1, 1));
